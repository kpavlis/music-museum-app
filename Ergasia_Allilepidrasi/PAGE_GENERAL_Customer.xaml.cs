...
namespace Ergasia_Allilepidrasi
{
    ...
    /// </summary>
    public sealed partial class PAGE_GENERAL_Customer : Page
    {
        MainWindow x;

        public PAGE_GENERAL_Customer()
        {
                ...
                if (item != null && item.Tag != null)
                {
                    ...
                    switch (selectedTag)
                    {
                        case "Page1":
                            ...
                            break;
                        case "Page2":
                            contentFrame.Navigate(typeof(Page_Customer_2));
                            break;
                        case "Page3":
                            contentFrame.Navigate(typeof(Page_Customer_3));
                            break;
                        case "Page4":
